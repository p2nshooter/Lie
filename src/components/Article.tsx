  ...
  return (
    <article className="mx-auto max-w-prose2 px-4">
      ...
      <p className="mt-4 text-xs leading-relaxed text-ink-800/60">
        This article is educational and general in nature — not medical advice. Individual skin varies; for any
        persistent or concerning skin condition, consult a qualified dermatologist or doctor.
      </p>
    </article>
  );
}
