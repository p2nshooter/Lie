    ...
    <footer className="relative mt-16 overflow-hidden bg-ink-900 text-ivory-100">
      ...
      <div className="relative mx-auto max-w-6xl px-4 py-12">
        ...
        <p className="mt-10 border-t border-ivory-100/10 pt-6 text-xs leading-relaxed text-ivory-100/50">
          Disclaimer: {SITE.name} publishes independent, educational skincare information only — it is not medical
          advice, diagnosis or treatment, and it does not replace a consultation with a qualified dermatologist or
          doctor. For any persistent, worsening or concerning skin problem, please see a professional. Individual
          skin varies; patch-test new products.
        </p>
